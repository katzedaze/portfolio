...
const COMMON_SKILLS = [
  ...
  'HTML', 'CSS', 'Sass', 'Tailwind CSS', 'Material-UI', 'Ant Design', 'Chakra UI',
  'Redux', 'Zustand', 'Recoil', 'React Query', 'SWR', 'Webpack', 'Vite', 'Remix',

  // バックエンド
  'Node.js', 'Express', 'Nest.js', 'Python', 'Django', 'Flask', 'FastAPI',
  'Ruby', 'Ruby on Rails', 'PHP', 'Laravel', 'Go', 'Gin', 'Echo', 'Java',
  'Spring Boot', 'Kotlin', 'C#', '.NET', 'Rust', 'Actix', 'Elixir', 'Phoenix',

  // データベース
  'PostgreSQL', 'MySQL', 'MongoDB', 'Redis', 'SQLite', 'DynamoDB', 'Firebase',
  'Supabase', 'Prisma', 'TypeORM', 'Sequelize', 'Drizzle ORM',
  ...
  // その他
  'Git', 'GitHub', 'GitLab', 'Bitbucket', 'Jest', 'Vitest', 'Cypress', 'Playwright',
  'Storybook', 'Figma', 'Adobe XD', 'Photoshop', 'Illustrator', 'GraphQL',
  'REST API', 'gRPC', 'WebSocket', 'Microservices', 'Serverless',
].sort();
