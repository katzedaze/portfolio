...
export const profileSchema = z.object({
  ...
  website: z
    ...
    .pipe(z.string().url("有効なURLを入力してください").optional()),
  githubUrl: z
    .string()
    .optional()
    .transform((val) => (val === "" ? undefined : val))
...
export const skillSchema = z.object({
  ...
  proficiency: z
    .string()
    .min(1, "習熟度は必須です")
    .max(50, "習熟度は50文字以内で入力してください"),
  yearsOfExperience: z
    .number()
    .min(0, "経験年数は0以上の値を入力してください")
    .max(50, "経験年数は50年以下で入力してください")
    .multipleOf(0.1, "経験年数は0.1刻みで入力してください"),
  displayOrder: z
    .number()
    .int("整数を入力してください")
    .min(0, "表示順序は0以上の値を入力してください"),
});
...
export const companySchema = z
  .object({
    name: z
      .string()
      .min(1, "社名は必須です")
      .max(200, "社名は200文字以内で入力してください"),
    industry: z
      .string()
      .max(100, "業界は100文字以内で入力してください")
      .optional()
      .or(z.literal("")),
    description: z
      .string()
      .max(5000, "会社概要は5000文字以内で入力してください")
      .optional()
      .or(z.literal("")),
...
export const projectSchema = z
  .object({
    ...
    responsibilities: z
      .string()
      .max(10000, "担当業務は10000文字以内で入力してください")
      .optional()
      .or(z.literal("")),
    achievements: z
      .string()
      .max(10000, "成果実績は10000文字以内で入力してください")
      .optional()
      .or(z.literal("")),
    displayOrder: z
      .number()
